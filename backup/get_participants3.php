<?php
	...
	{	
		...
		$allow_preorder = $participantRow['allow_preorder'];
		if($allow_preorder==1)
			$allow_preorder_status = "YES";
		else
			$allow_preorder_status = "NO";
		$tmpentry[] = htmlspecialchars($allow_preorder_status);	
		$tmpentry[] = $action;
