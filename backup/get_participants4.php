<?php
	...
	$techResult = $participantbol->select_participant_list($DisplayStart,$DisplayLength,$SortingCols,$cri_arr,$login_organizer_id);
	...
	{	
		...
		//edit btn
		$action ="<a title='Edit' href='edit_participant.php?participant_id=$participant_id'><img src='images/blue_edit.gif' border='0'></a>&nbsp;&nbsp;";
		...
		$allow_canteenorder = $participantRow['allow_canteen_order'];
		if($allow_canteenorder==1)
			$allow_canteenorder_status = "YES";
		else
			$allow_canteenorder_status = "NO";
		$tmpentry[] = htmlspecialchars($allow_canteenorder_status);	
		$tmpentry[] = $action;
