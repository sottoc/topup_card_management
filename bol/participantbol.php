<?php
	class participantbol
	{
		...
		{
			$participantdal=new participantdal();
			$result=$participantdal->checkNameAndId($name, $id);
			return $result;
		}
		...
		{
			$participantdal = new participantdal();
			$result = $participantdal -> select_allergyfoods_by_predefinedid($id);
			return $result;
		}
		...
		{
			$participantdal = new participantdal();
			$result = $participantdal -> update_participant_uploadfile($participantinfo);
			return $result;
		}
	}
?>