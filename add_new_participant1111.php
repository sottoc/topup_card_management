...
<script type="text/javascript">			
	...
	function checkIDandName()
	{
		...
		$("#txt_participant_name").attr("disabled", "disabled"); 
		$("#txt_participant_id").attr("disabled", "disabled"); 
	...
	/* function check_match_btn_click()
	{
		alert(click_match_btn);
	} */
</script>
<style type="text/css">
</style>
