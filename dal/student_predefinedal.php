...
//----------student predefine setup----------//
		...
		function check_duplicate_studentID($studentID,$id)
		{
			$query="SELECT count(predefine_participant_id) as count_duplicate_saving FROM tbl_student_predefine WHERE predefine_participant_enroll_no=:studentID and predefine_participant_id!=:id";
			$result = execute_query($query,array(':studentID'=>$studentID,':id'=>$id)) or die ("check_duplicate_studentID query fail.");
			return new readonlyresultset($result);
		}
		...
		function update_student_predefine_uploadfile($student_predefineinfo)
		{
			$predefine_participant_id= $student_predefineinfo->get_predefine_participant_id();
			$upload_file = $student_predefineinfo->get_upload_file();
			$query="UPDATE tbl_student_predefine SET upload_file= :upload_file WHERE predefine_participant_id= :predefine_participant_id; ";		
			$param = array(
