<?php
	...
	$rResult= $userbol->get_user_list($DisplayStart,$DisplayLength,$SortingCols,$cri_arr);
	...
	while( $aRow = $rResult->getNext() )
	{
		...
		$tmpentry = array();
		$tmpentry[] = htmlspecialchars($user_name);
		$tmpentry[] = htmlspecialchars($user_email);
		$tmpentry[] = htmlspecialchars($user_type_name);
		$tmpentry[] = htmlspecialchars($user_address);
		$tmpentry[] = htmlspecialchars($user_phone);
